 ...
 */
@Repository
public interface YonyouPersonImportRepositorySec extends JpaRepository<YonyouPersonImportSec, String> {
...
//    @Query(value = "select PERSONNUM as personnum from EmpInfo_Kronos_V ", nativeQuery = true)
//    List<YonyouPersonImportSec>;
}
