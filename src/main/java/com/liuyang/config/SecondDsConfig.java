...
@EnableJpaRepositories(basePackages = "com.liuyang.entitySec", entityManagerFactoryRef = "secondEntityManagerFactory", transactionManagerRef = "secondTransactionManager")
public class SecondDsConfig {
    ...
    public LocalContainerEntityManagerFactoryBean secondEntityManagerFactory(
        ...
        return builder
                ...
                .packages("com.liuyang.entitySec")
