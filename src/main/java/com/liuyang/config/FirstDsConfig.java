...
@EnableJpaRepositories(basePackages = "com.liuyang.entity", entityManagerFactoryRef = "firstEntityManagerFactory", transactionManagerRef = "firstTransactionManager")
